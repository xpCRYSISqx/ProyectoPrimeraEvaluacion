...
public class ListaTareasHechas extends AppCompatActivity {
    ...
    public void irTareasPendientes(View view){
    ...
    public void cargarTareas(){
        ...
        Cursor fila = bd.rawQuery("select * from tareas where hecha = 's'", null);
    ...
    class AdaptadorTarea extends ArrayAdapter<Tarea>{
        ...
        AdaptadorTarea(AppCompatActivity context) {  super(context, R.layout.estilo_listas, listaTareas);  appCompatActivity = context;  }
